...
/// 8 × vec4 = 128 bytes; all fields 16-byte aligned for WebGPU.
...
pub fn stat_radar_update_system(
    ...
    for (node, mat_node) in query.iter() {
        ...
        let new_2 = Vec4::new(r[8], r[9], r[10], r[11]);
        if mat.uniforms.ratios_0 != new_0 || mat.uniforms.ratios_1 != new_1 || mat.uniforms.ratios_2 != new_2 {
            mat.uniforms.ratios_0 = new_0;
            mat.uniforms.ratios_1 = new_1;
            mat.uniforms.ratios_2 = new_2;
        }
    }
}
