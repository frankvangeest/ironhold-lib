...
fn test_new_id_token_produces_unique_ids_across_spawns() {
    ...
    app.world_mut().resource_mut::<ActionQueue>().push(
        Action::Spawn { prefab: "enemy_orc_melee".to_string(), id: Some("orc_corpse_{new_id}".to_string()), position: None, spawn_point: None, yaw_deg: None }
    );
    app.world_mut().resource_mut::<ActionQueue>().push(
        Action::Spawn { prefab: "enemy_orc_melee".to_string(), id: Some("orc_corpse_{new_id}".to_string()), position: None, spawn_point: None, yaw_deg: None }
    );
...
fn test_new_id_token_shares_counter_with_auto_generated_fallback() {
    ...
    app.world_mut().resource_mut::<ActionQueue>().push(
        Action::Spawn { prefab: "enemy_orc_melee".to_string(), id: Some("loot_{new_id}".to_string()), position: None, spawn_point: None, yaw_deg: None }
    );
    app.update();
